// Shared form component for bidding projects (used in both normal project creation and tender vault)
...
export default function BiddingProjectForm({
  projectData,
  setProjectData,
  onSubmit,
  onCancel,
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
      ...
      <div className="p-6 bg-gradient-to-b from-orange-400 to-red-500 border-b border-slate-100">
        ...
        <p className="text-white/90">Tell us about your project</p>
      </div>
        ...
        <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200">
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <span className="block text-xs text-slate-500 mb-1">Min</span>
                <input
                  name="budget_min"
                  type="number"
                  min={1}
              ...
              <div>
                <span className="block text-xs text-slate-500 mb-1">Max</span>
                <input
                  name="budget_max"
                  type="number"
                  min={1}
        ...
        <div className="flex gap-3">
          {showCancel && onCancel && (
            <button
              type="button"
              onClick={onCancel}
              className="flex-1 px-4 py-2.5 border border-slate-300 rounded-xl font-semibold text-slate-700 hover:bg-slate-50 transition"
            >
              Cancel
            </button>
          )}
          <button
            ...
            className={`flex-1 h-12 rounded-xl font-semibold transition flex items-center justify-center gap-2 ${
